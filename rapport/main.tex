...
\begin{itemize}
  \item $(x,y,nord) \longrightarrow  \{(x,y,est), (x,y,ouest)\} \cup \{(x-i,y,nord) : i \in \{1,2,3\}, N > x-i \geq 0, (x-i, y) \notin O\}$
  \item $(x,y,est) \longrightarrow  \{(x,y,nord), (x,y,sud)\} \cup \{(x,y+i,est) : i \in \{1,2,3\}, N > y+i \geq 0, (x, y+i) \notin O\}$
  \item $(x,y,sud) \longrightarrow  \{(x,y,ouest), (x,y,est)\} \cup \{(x+i,y,sud) : i \in \{1,2,3\}, N > x+i \geq 0, (x+i, y) \notin O\}$
  \item $(x,y,ouest) \longrightarrow  \{(x,y,sud), (x,y,nord)\} \cup \{(x,y-i,ouest) : i \in \{1,2,3\}, M > y-i \geq 0, (x, y-i) \notin O\}$
\end{itemize}
